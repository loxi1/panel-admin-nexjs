...
async function getData() {
  ...
  `);
  return rs.recordset as Array<{ cod: string; nombre: string; email: string; activo: number }>;
}
  ...
  return (
    <DefaultLayout>
      <PageHeader
        ...
        actions={<div className="hidden sm:block text-gray-400 text-sm">{rows.length} usuario(s)</div>}
      />
          ...
          <table className="min-w-full text-sm">
            <thead className="text-left text-gray-500 dark:text-gray-400">
              <tr className="[&>th]:px-5 [&>th]:py-3">
                <th>CÓDIGO</th><th>NOMBRE</th><th>EMAIL</th><th>ESTADO</th>
              </tr>
            </thead>
